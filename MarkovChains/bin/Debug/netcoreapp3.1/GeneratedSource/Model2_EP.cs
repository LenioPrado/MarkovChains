...
namespace Models
{
	...
	public partial class Model2_EP : IGeneratedAlgorithm
	{
		...
		private void Changed_vGamma1_vGaussian1()
		{
			...
			vdouble7_uses_F = new Gaussian[2];
			...
			vdouble7_uses_F[0] = ReplicateOp_NoDivide.UsesAverageConditional<Gaussian>(vdouble7_uses_B, vdouble7_F, 0, vdouble7_uses_F[0]);
			// Message to 'vdouble7_uses' from Replicate factor
			vdouble7_uses_F[1] = ReplicateOp_NoDivide.UsesAverageConditional<Gaussian>(vdouble7_uses_B, vdouble7_F, 1, vdouble7_uses_F[1]);
